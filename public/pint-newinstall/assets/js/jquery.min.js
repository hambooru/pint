...
!(function(e, t) {
  ...
  (S.fn = S.prototype = {
    ...
    even : function() {
      return this.pushStack(
          S.grep(this, function(e, t) { return (t + 1) % 2; }));
    },
    odd : function() {
  ...
  (S.find = d), (S.expr = d.selectors), (S.expr[":"] = S.expr.pseudos),
      ...
      (S.isXMLDoc = d.isXML), (S.contains = d.contains),
  ...
  S.fn.extend({
    ...
    addBack : function(e) {
      ...
      S.each({
        ...
        siblings : function(
            e) { return T((e.parentNode || {}).firstChild, e); },
  ...
  function xe(e, t, n, r, i) {
    ...
    while ((o = p[d++]))
      if (r && -1 < S.inArray(o, r))
        i && i.push(o);
      else if (((l = ie(o)), (a = ve(f.appendChild(o), "script")), l && ye(a),
                n)) {
        c = 0;
        while ((o = a[c++]))
  ...
  function Ee(e, t, n, r, i, o) {
    ...
    return (
        1 === o &&
            ((a = i),
             ((i = function(e) { return S().off(e), a.apply(this, arguments); })
  ...
  S.extend({
    ...
    style : function(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if ((u || (t = ze(s)), (a = S.cssHooks[t] || S.cssHooks[s]),
             void 0 === n))
      ...
      (((S.Tween = Ke).prototype = {
         ...
         init : function(e, t, n, r, i, o) {
           (this.elem = e), (this.prop = n),
               (this.easing = i || S.easing._default), (this.options = t),
  ...
  (S.Animation = S.extend(lt, {
    ...
    prefilter : function(
      ...
      (S.fx.interval = 13),
      (S.fx.start = function() { et || ((et = !0), ot()); }),
      ...
      ((tt = E.createElement("input")).value = "t"), (tt.type = "radio"),
    ...
    removeAttr : function(
      ...
      S.each(S.expr.match.bool.source.match(/\w+/g), function(e, t) {
        ...
        ft[t] = function(e, t, n) {
          ...
          return (n || ((i = ft[o]), (ft[o] = r),
                        (r = null != a(e, t, n) ? o : null), (ft[o] = i)),
                  r);
        };
      });
  ...
  S.fn.extend({
    ...
    removeProp : function(e) {
      return this.each(function() { delete this[S.propFix[e] || e]; });
    },
  }),
      S.extend({
        prop : function(e, t, n) {
            ...
            r || e.isDefaultPrevented() ||
                ...
                (u && m(n[d]) && !x(n) &&
                 ((a = n[u]) && (n[u] = null), (S.event.triggered = d),
                  e.isPropagationStopped() && f.addEventListener(d, xt), n[d](),
  ...
  (Mt.href = bt.href), S.extend({
    ...
    getScript : function(e, t) { return S.get(e, void 0, t, "script"); },
      ...
      S.fn.extend({
        ...
        wrapInner : function(n) {
          return m(n) ? this.each(function(
                            e) { S(this).wrapInner(n.call(this, e)); })
                      : this.each(function() {
        ...
        wrap : function(t) {
          var n = m(t);
          return this.each(function(
              e) { S(this).wrapAll(n ? t.call(this, e) : t); });
        },
        unwrap : function(e) {
      ...
      (S.expr.pseudos.hidden = function(
           e) { return !S.expr.pseudos.visible(e); }),
  ...
  S.ajaxSetup({
    ...
    jsonpCallback : function() {
                     ...
                     S.ajax({
                        ...
                        data : t,
                         ...
                         .done(function(e) {
                           (o = arguments),
                               a.html(
                                   r ? S("<div>").append(S.parseHTML(e)).find(r)
                                     : e);
                         })
                         .always(
                             n &&
      ...
      (S.expr.pseudos.animated =
           function(t) {
             return S.grep(S.timers, function(e) { return t === e.elem; })
                 .length;
           }),
      (S.offset = {
  ...
  (S.proxy =
      ...
      (S.trim = function(
           e) { return null == e ? "" : (e + "").replace(Xt, ""); }),
      "function" == typeof define && define.amd &&
          define("jquery", [], function() { return S; });
  var Vt = C.jQuery, Gt = C.$;
  return ((S.noConflict = function(e) {
            return C.$ === S && (C.$ = Gt),
                   e && C.jQuery === S && (C.jQuery = Vt), S;
